<script generics="Input extends RemoteFormInput, V extends number | string" lang="ts">
  ...
  interface Props {
    /** The `<Option>` list — the whole point of this component vs. `SelectField`. */
    children: Snippet;
    class?: string;
